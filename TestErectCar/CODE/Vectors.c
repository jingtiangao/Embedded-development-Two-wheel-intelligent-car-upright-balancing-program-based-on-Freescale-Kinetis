...
volatile asm void _vect(void) {
  ...
  JSR  MOTOR1DIR_Interrupt             /* Interrupt no. 24 (Used)   - ivINT_GPIO_B  */
  JSR  MOTOR2DIR_Interrupt             /* Interrupt no. 25 (Used)   - ivINT_GPIO_A  */
  ...
  JSR  ADC_InterruptCC                 /* Interrupt no. 40 (Used)   - ivINT_ADCA_Complete  */
...
/*lint -esym(765,MOTOR1DIR_Interrupt) Disable MISRA rule (23) checking for symbols (MOTOR1DIR_Interrupt). */
/*lint -esym(765,MOTOR2DIR_Interrupt) Disable MISRA rule (23) checking for symbols (MOTOR2DIR_Interrupt). */
/*lint -esym(765,COUNTER1_Interrupt) Disable MISRA rule (23) checking for symbols (COUNTER1_Interrupt). */
/*lint -esym(765,COUNTER2_Interrupt) Disable MISRA rule (23) checking for symbols (COUNTER2_Interrupt). */
/*lint -esym(765,TI1_Interrupt) Disable MISRA rule (23) checking for symbols (TI1_Interrupt). */
/*lint -esym(765,ADC_InterruptCC) Disable MISRA rule (23) checking for symbols (ADC_InterruptCC). */
